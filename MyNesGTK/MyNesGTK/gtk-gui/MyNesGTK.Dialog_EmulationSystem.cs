...
namespace MyNesGTK
{
	public partial class Dialog_EmulationSystem
	{
		...
		protected virtual void Build ()
		{
			...
			// Widget MyNesGTK.Dialog_EmulationSystem
			this.Name = "MyNesGTK.Dialog_EmulationSystem";
			this.Title = "Emulation system";
			this.WindowPosition = ((global::Gtk.WindowPosition)(4));
			// Internal child MyNesGTK.Dialog_EmulationSystem.VBox
			...
			this.combobox1.AppendText ("Auto");
			this.combobox1.AppendText ("NTSC");
			this.combobox1.AppendText ("PAL");
			this.combobox1.AppendText ("DENDY");
			...
			this.label1.LabelProp = "Emulation system:";
			...
			this.label2.LabelProp = "You need to restart current game to apply";
			...
			w5.Expand = false;
			w5.Fill = false;
			// Internal child MyNesGTK.Dialog_EmulationSystem.ActionArea
