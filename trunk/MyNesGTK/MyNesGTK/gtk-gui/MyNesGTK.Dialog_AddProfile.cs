...
namespace MyNesGTK
{
	public partial class Dialog_AddProfile
	{
		...
		protected virtual void Build ()
		{
			...
			// Widget MyNesGTK.Dialog_AddProfile
			this.Name = "MyNesGTK.Dialog_AddProfile";
			this.WindowPosition = ((global::Gtk.WindowPosition)(4));
			// Internal child MyNesGTK.Dialog_AddProfile.VBox
			...
			this.label1.LabelProp = "Profile name:";
			...
			this.label2.LabelProp = "Copy mappings from:";
			...
			w6.Expand = false;
			w6.Fill = false;
			// Internal child MyNesGTK.Dialog_AddProfile.ActionArea
