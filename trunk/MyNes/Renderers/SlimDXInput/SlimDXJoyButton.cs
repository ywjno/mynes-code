...
{
    public class SlimDXJoyButton
    {
        private SlimDXInputManager _manager;
        private int _device;
        private int _code;
        ...
        public SlimDXJoyButton(SlimDXInputManager manager)
        {
            _manager = manager;
        }
        ...
        public bool IsPressed()
        {
            ...
            SlimDXInputDevice device = _manager.Devices[_device];
