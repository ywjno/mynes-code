...
namespace MyNes
{
    public partial class FormConsole : Form
    {
        ...
        {
            this.Location = Program.Settings.ConsoleWindowLocation;
            this.Size = Program.Settings.ConsoleWindowSize;
        }
        private void SaveSettings()
        {
            Program.Settings.ConsoleWindowLocation = this.Location;
            Program.Settings.ConsoleWindowSize = this.Size;
        }
